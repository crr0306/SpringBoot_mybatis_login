...
public class ParamTokenInterceptor implements HandlerInterceptor {
    private static final Logger logger = LoggerFactory.getLogger(ParamTokenInterceptor.class);
//    @Autowired
//    private ICacheService iCacheService;

    @Override
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        logger.info("ParamTokenInterceptor.preHandle:::uri, tag, loginToken: {}, {}, {}", request.getRequestURI(), request.getParameter("tag"), request.getParameter("loginToken"));
...
//        iCacheService.expire(phonePrifix + redisUserInfo.split(":")[1], expireTime);
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        logger.debug("ParamTokenInterceptor.postHandle...");
    }

    @Override
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) throws Exception {
        logger.debug("ParamTokenInterceptor.afterCompletion...");
    }
